...
import ua.luckydev.entity.Worker;
import ua.luckydev.ejb.PersonEntityEJB;
...
public class PersonneBean implements Serializable
{
    ...
    PersonEntityEJB personEntityEJB;
    ...
    public void init()
    {
        ...
        listWorkers.addAll(personEntityEJB.listWorkers());
    ...
    public PersonEntityEJB getPersonEntityEJB()
    {
        return personEntityEJB;
    }

    public void setPersonEntityEJB(PersonEntityEJB personEntityEJB)
    {
        this.personEntityEJB = personEntityEJB;
    }
...
//    }
    ...
    public void actionAddWorker(ActionEvent actionEvent)
    {
        ...
        context.addMessage(null, new FacesMessage("Add worker"));
        init();
        this.worker = new Worker();
    }
    ...
    {
        this.worker = personEntityEJB.getWorker(id);
    }

    public void updatePerson(ActionEvent actionEvent)
    {
        personEntityEJB.updateWorker(worker);
        FacesContext context = FacesContext.getCurrentInstance();
    ...
    {
        System.out.println(worker);
        personEntityEJB.deleteWorker(worker);
        FacesContext context = FacesContext.getCurrentInstance();
    ...
    public String addWorker()
    {
        ...
        personEntityEJB.addWorker(worker);
        // Add message
