...
public class TagCloudManagedBean {
	...
	public TagCloudManagedBean(){
		...
		TagCloudItem primefaces = new DefaultTagCloudItem("Primefaces","http://www.journaldev.com/dev/primefaces", 5);
		TagCloudItem hibernate = new DefaultTagCloudItem("Hibernate","http://www.journaldev.com/dev/hibernate", 5);
		TagCloudItem apachePluto = new DefaultTagCloudItem("Apache PlutoS", 5);
		TagCloudItem spring = new DefaultTagCloudItem("Spring", 5);
		TagCloudItem grails = new DefaultTagCloudItem("Grails", 5);
		TagCloudItem apacheLvy = new DefaultTagCloudItem("Apache lvy", 5);
